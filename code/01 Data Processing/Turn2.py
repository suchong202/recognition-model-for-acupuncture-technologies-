...
if __name__ == '__main__':
    ...
    save = 'E:/Code/02 Classifier training/data/V/E1.xlsx'
    model_data1(url, save, 24 * 6)


    save = 'E:/Code/02 Classifier training/data/V/E2.xlsx'
    model_data2(url, save, 24 * 6)


    save = 'E:/Code/02 Classifier training/data/V/E3.xlsx'
    model_data3(url, save, 24 * 6)
